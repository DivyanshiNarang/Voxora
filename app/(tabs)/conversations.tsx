  ...
  const handleStartCustomConversation = async () => {
    ...
    try {
      ...
      if (error) {
        ...
        Toast.show({
          type: 'error',
          text1: 'Could not generate scenario',
      ...
      Toast.show({
        type: 'error',
        text1: 'Could not start Free Talk',
      ...
      <View style={{ flex: 1 }}>
        ...
        >
          ...
          <View style={styles.gridContainer}>
            {[...customScenarios, ...COURSE_DATA.languages[selectedLanguage].scenarios].map((scenario) => (
              <TouchableOpacity
                key={scenario.id}
                style={[
                  styles.scenarioCard,
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() => {
                      ...
                      if (!entries.length) {
                        Toast.show({
                          type: 'error',
                          text1: 'No phrasebook available',
                          text2: "This scenario doesn't have phrasebook entries yet."
                        });
                        return;
                      }
