...
export default function OnboardingScreen() {
  ...
  const saveProfile = async () => {
    try {
      ...
      const { error } = await supabase.from("profiles").upsert({
        ...
        active_languages: selectedLanguages,
      ...
      Toast.show({
        type: 'error',
        text1: 'Failed to save your profile.',
  ...
  const renderStep1Language = () => (<View style={styles.stepContainer}>
    ...
    <View style={styles.tagsContainer}>
      {Object.keys(COURSE_DATA.languages).map((i) => {
        const isSelected = selectedLanguages.includes(i);
  ...
  const renderStep2Level = () => (
    <View style={styles.stepContainer}>
      <ThemedText type="title" style={styles.title}>
        How much {selectedLanguages[0]} do you know?
      </ThemedText>
  ...
  const renderStep3Motivation = () => (
    <View style={styles.stepContainer}>
      <ThemedText type="title" style={styles.title}>
        Why are you learning {selectedLanguages[0]}?
      </ThemedText>
