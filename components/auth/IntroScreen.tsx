...
const logoSource = require("../../assets/images/voxora-minimal.png");
...
export default function IntroScreen() {
  ...
  const mainTextWords: string[] = ["Learn", "Languages", "the", "right", "way"];
    ...
    <Animated.View style={[styles.viewContainer, menuContentAnimatedStyle]}>
      <View style={styles.logoSection}>
        <View style={styles.logoContainer}>
          ...
          <Text style={styles.appName}>Voxora</Text>
        </View>
