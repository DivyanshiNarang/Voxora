...
import { getOptionPhrase, LANGUAGE_NAME } from "@/lib/phraseUtils";
...
export default function SingleResponseMode({
  ...
  const optionPhrase = getOptionPhrase(option, selectedLanguage);
      ...
      <View style={styles.promptContainer}>
        ...
        >
          <ThemedText style={styles.sayItPrompt}>
            Record this response in {LANGUAGE_NAME[selectedLanguage]}
          </ThemedText>
        </Animated.View>
      </View>
      <View
