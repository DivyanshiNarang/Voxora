...
export default function Flashcard({
  ...
  word: Word;
  direction: "english-script" | "script-english";
}) {
  ...
  const FrontContent = () => {
    ...
    return (
      <View style={styles.mandarinContent}>
        <ThemedText style={styles.pinyin}>{word.pronunciation}</ThemedText>
        <ThemedText style={styles.hanzi}>{word.primaryText}</ThemedText>
      </View>
    );
  };
