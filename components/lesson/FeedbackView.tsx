...
import { getOptionPhrase } from "@/lib/phraseUtils";
...
export function FeedbackView({
  ...
  const correctPhrase = getOptionPhrase(correctOption, selectedLanguage);
